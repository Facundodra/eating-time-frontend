  ...
  return (
    <div className="restaurant-menu space-y-1">
      {restaurantNavGroups.map((group) => (
        <div key={group.label}>
          <p className="nav-links-name mb-1.5 text-[11px] font-black uppercase text-slate-400 dark:text-slate-500">
            {group.label}
          </p>
                  ...
                  <Link className="flex items-center gap-2" href={link.href}>
                    <Icon
                      className={clsx("h-[18px] w-[18px] shrink-0 transition-all duration-300", {
                        ...
                        "text-slate-600 group-hover/li:text-orange-700 dark:text-slate-300 dark:group-hover/li:text-orange-400": !isActive,
                      })}
                    />
                    <span
                      className={clsx(
                        "relative top-[1px] overflow-hidden whitespace-nowrap text-sm font-semibold transition-all duration-300 group-hover/li:text-orange-700 dark:group-hover/li:text-orange-400",
                        {
                          "text-orange-700 dark:text-orange-400": isActive,
