            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="mt-1 text-sm font-medium text-slate-500 dark:text-slate-400">
                  Ingresa la contraseña actual y definí una nueva para el acceso
                  administrador.
                </p>
              </div>
            </div>
          ...
          <div className="rounded-2xl border border-gray-200 bg-white p-5 shadow-sm dark:border-slate-800 dark:bg-slate-900">
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="mt-1 text-sm font-medium text-slate-500 dark:text-slate-400">
                  Usa una contraseña de al menos 8 caracteres y evita repetir
          ...
          <div className="rounded-2xl border border-gray-200 bg-white p-5 shadow-sm dark:border-slate-800 dark:bg-slate-900">
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="mt-1 text-sm font-medium text-slate-500 dark:text-slate-400">
                  Accede a la pantalla de datos para editar nombre o teléfono.
                </p>
              </div>
            </div>
            <Link
