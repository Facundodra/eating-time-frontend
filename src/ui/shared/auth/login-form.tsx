  ...
  return (
    <section className="w-full max-w-[420px] rounded-[28px] border border-gray-200 bg-white px-5 py-8 shadow-[0_24px_80px_rgba(15,23,42,0.12)] dark:border-slate-800 dark:bg-slate-900 sm:px-9 sm:py-10">
      <div>
        ...
        <p className="mt-3 max-w-[310px] text-sm leading-6 font-medium text-slate-400 dark:text-slate-400">
          Accedé a tu cuenta para continuar utilizando Eating Time.
        </p>
      </div>

      {reason && loginReasonMessages[reason] ? (
        <p className="mt-6 rounded-2xl border border-orange-200 bg-orange-50 px-4 py-3 text-sm font-bold text-orange-800 dark:border-orange-500/30 dark:bg-orange-500/10 dark:text-orange-200">
      ...
      <div className="space-y-4">
        <div className="flex flex-col gap-4 rounded-2xl border border-gray-200 px-5 py-4 dark:border-slate-800 min-[380px]:flex-row min-[380px]:items-center min-[380px]:justify-between">
          <div>
            ...
            <p className="mt-1 max-w-[190px] text-xs leading-5 font-medium text-slate-400 dark:text-slate-400">
        ...
        <div className="flex flex-col gap-4 rounded-2xl border border-orange-100 bg-orange-50 px-5 py-4 dark:border-orange-500/20 dark:bg-orange-500/10 min-[380px]:flex-row min-[380px]:items-center min-[380px]:justify-between">
          <div>
            ...
            <p className="mt-1 max-w-[190px] text-xs leading-5 font-medium text-orange-900/55 dark:text-orange-200/80">
